...
function startCameraCapture() {
    ...
    const command = `libcamera-vid -t 0 --width 640 --height 480 --framerate 30 --inline --flush
  --codec h264 --level 4.0 --bitrate 1000000 --intra 30
  -o - | ffmpeg -i - -c:v copy -f mpegts -`;
